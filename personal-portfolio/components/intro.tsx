    ...
    >
        ...
        <div className="relative">
          ...
          >
            <Image
              ...
              quality="95"
              priority={true}
              className="h-24 w-24 rounded-full object-cover border border-white shadow-xl"
            />
          </motion.div>
      ...
      >
        ...
        <a
          ...
          href="https://www.linkedin.com/in/lgaducew/"
          target="_blank"
        >
          <BsLinkedin />
        </a>
        ...
        <a
          className="bg-white p-4 text-gray-700 flex items-center gap-2 text-[1.35rem] rounded-full hover:scale-[1.15] hover:text-gray-950 active:scale-105 transition cursor-pointer borderBlack dark:bg-white/10 dark:text-white/60"
          href="https://www.instagram.com/gdz_leo/"
          target="_blank"
        >
          <FaInstagramSquare />
        </a>
